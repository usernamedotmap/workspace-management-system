...
import { createProjectController, deleteProjectController, getAllProjectsInWorkspaceController, getProjectAnalyticsController, getProjectByIdInWorkspaceController, updateProjectController } from "../controllers/project.controller";
...
projectRoutes.get("/:id/workspace/:workspaceId", getProjectByIdInWorkspaceController);
