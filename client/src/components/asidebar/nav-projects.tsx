...
export function NavProjects() {
  ...
  const pagination = data?.paginations || ({} as PaginationType);
    ...
    <PageMeta title="Workspace Projects" description="List of projects in the workspace" />
      <SidebarGroup className="group-data-[collapsible=icon]:hidden">
        ...
        <SidebarMenu className="h-[320px] scrollbar overflow-y-auto pb-2">
          ...
          {hasMore && (
            <SidebarMenuItem>
              <SidebarMenuButton className="text-sidebar-foreground/70" disabled={isFetching} onClick={fetchNextPage}>
      ...
      <ConfirmDialog
        ...
        description={
          <>Are you sure you want to delete <strong className="text-red-500">{context?.name || "this item"
