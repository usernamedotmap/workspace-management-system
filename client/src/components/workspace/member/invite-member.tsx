...
const InviteMember = () => {
  ...
  const inviteUrl = workspace ? `${window.location.origin}${BASE_ROUTE.INVITE_URL.replace(":inviteCode", workspace.inviteCode)}` : "";
  ...
  return (
    <div className="flex flex-col pt-0.5 px-0 ">
      ...
      {workspaceLoading ? (
       <Loader className="h-8 w-8 place-self-center flex animate-spin" />
